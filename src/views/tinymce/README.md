...
## NodeJs
  ...
  - fs文件系统
  - 创建本地服务(server | express)

## http
## 解决git push失败 的权限问题
git remote set-url origin https://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@github.com/bonniebonnieljj/MyAllStacks.git

## 生成项目结构
- npm install -g treer
- treer --help
- treer -d ./lib -e ./menu.text -i node_modules

## 富文本插件tinymce
- 删除package-lock.json
- npm install tinymce --S
- npm install @tinymce/tinymce-vue@3
- 将node_modules中的tinymce文件拷贝到public/assets中
- 去tinymce下载汉化包放到public/assets/tinymce/lang/ch_CN.js
- 创建tinymce.vue组件
```html
<template>
    <div id="tinymce-wrap">
